...
public class MerchantController {
    ...
    public BaseResponse createOrgMcht() throws Exception {
        ...
        mchtBase.setAreaNo("310112");//经营区域码
        ...
        mchtUser.setCardNo(SdkUtil.encrypt("452229200104242211"));//证件号码
        ...
        mchtComp.setLicenseNo(SdkUtil.encrypt("91310112MA1GD0BX4D"));//营业执照号码
        ...
        mchtAcct.setAcctZbankCode("310112");//支行区域编码
        ...
        mchtMedia.setCertFront("VQRX3pXP5g/4AVUr7ajon+0RkO8vTcKttmcoCKSVDVg=");
        ...
        mchtMedia.setBankCardPositive("VQRX3pXP5g/4AVUr7ajon+0RkO8vTcKttmcoCKSVDVg=");
        mchtMedia.setHandheld("VQRX3pXP5g/4AVUr7ajon+0RkO8vTcKttmcoCKSVDVg=");
        mchtMedia.setCertReverse("VQRX3pXP5g/4AVUr7ajon+0RkO8vTcKttmcoCKSVDVg=");
    ...
    public BaseResponse queryMcht() throws Exception {
        ...
        paramsData.put("instMchtNo", "10000000005");
