...
import com.aomi.pay.entity.EsItems;
import com.aomi.pay.mapper.EsItemsMapper;
//import com.aomi.pay.repository.EsItemsRepository;
import com.aomi.pay.service.EsItemsService;
import com.aomi.pay.vo.EsItemsVO;
import lombok.extern.slf4j.Slf4j;
//import org.elasticsearch.pay.lucene.pay.function.FunctionScoreQuery;
import org.elasticsearch.index.query.BoolQueryBuilder;
import org.elasticsearch.index.query.QueryBuilders;
import org.elasticsearch.index.query.functionscore.FunctionScoreQueryBuilder;
import org.elasticsearch.index.query.functionscore.ScoreFunctionBuilders;
//import org.elasticsearch.pay.sort.SortBuilders;
//import org.elasticsearch.pay.sort.SortOrder;
...
public class EsItemsServiceImpl implements EsItemsService {
    ...
    public int importAll() {
        ...
        Iterable<EsItems> esProductIterable = null;//esItemsRepository.saveAll(esItemstList);
    ...
    @Override
    public PageResult pay(String keyword, Integer pageNum, Integer pageSize) {
        //page是从0开始的，要减1
    ...
    @Override
    public PageResult pay(String keyword, Integer categoryId, Integer pageNo, Integer pageSize, Integer sort) {
        //page是从0开始的，要减1
        ...
        try {
            //搜索查询
            //esItemsPage = esItemsRepository.pay(searchQuery);
        } catch (Exception e) {
            //CommonExceptionUtils.throwSystemException(CommonErrorCode.E_ITEMS_SEARCH);
        }
